...
#=====|Multiply|=====#
    execute if score @s nb.killSmSlime matches 21 as @e[type=slime,tag=!nb.dungeonSlime,distance=..8,name="Sludge"] at @s run function dungeons:rooms/global/sludge/tiny/spawn
